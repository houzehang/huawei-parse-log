...
class Parser {
    ...
    parse(channelId, dev, callback){
        ...
        this.$pre_content   = String.raw`### 频道消息查询
[checker website](http://121.36.22.201:8080/mxlog ':include :type=iframe width=100% height=50px')
### 声网水晶球`
        ...
        this.$type_hash     = {
            ...
            '#unmuteall': ['开启所有人声音','purple'],
            '#muteall': ['关闭所有人声音','purple'],
